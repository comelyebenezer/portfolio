...
export const HERO_CONTENT = `I'm a detail-oriented Front-End Developer with a strong foundation in Computer Science, passionate about building intuitive and high-performance web applications. Skilled in modern front-end technologies, I focus on creating seamless user experiences with clean, efficient code. Adaptable and always eager to learn, I stay updated with industry trends to deliver innovative solutions. Beyond coding, I enjoy Afrobeat and the lyrical depth of hip-hop legends like Eminem, Nas, and Lil Wayne.`;
